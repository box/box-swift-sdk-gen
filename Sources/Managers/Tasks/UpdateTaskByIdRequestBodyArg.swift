...
public class UpdateTaskByIdRequestBodyArg: Codable {
    ...
    ///     * `any_assignee` accepts any one assignee to review or
    ///     approve the the task in order for it to be considered completed.
    public init(action: UpdateTaskByIdRequestBodyArgActionField? = nil, message: String? = nil, dueAt: String? = nil, completionRule: UpdateTaskByIdRequestBodyArgCompletionRuleField? = nil) {
        self.action = action
    ...
    required public init(from decoder: Decoder) throws {
        ...
        action = try container.decodeIfPresent(UpdateTaskByIdRequestBodyArgActionField.self, forKey: .action)
        message = try container.decodeIfPresent(String.self, forKey: .message)
        dueAt = try container.decodeIfPresent(String.self, forKey: .dueAt)
        completionRule = try container.decodeIfPresent(UpdateTaskByIdRequestBodyArgCompletionRuleField.self, forKey: .completionRule)
    }
