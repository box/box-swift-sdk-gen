...
public class AddClassificationRequestBodyArgDataFieldStaticConfigFieldClassificationField: Codable {
    ...
    /// Initializer for a AddClassificationRequestBodyArgDataFieldStaticConfigFieldClassificationField.
    ///
    /// - Parameters:
