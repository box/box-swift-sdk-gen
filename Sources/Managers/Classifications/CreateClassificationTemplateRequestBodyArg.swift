...
public class CreateClassificationTemplateRequestBodyArg: Codable {
    ...
    /// Initializer for a CreateClassificationTemplateRequestBodyArg.
    ///
    /// - Parameters:
    ...
    ///     copied along when the file or folder is
    ///     copied.
    public init(scope: CreateClassificationTemplateRequestBodyArgScopeField, templateKey: CreateClassificationTemplateRequestBodyArgTemplateKeyField, displayName: CreateClassificationTemplateRequestBodyArgDisplayNameField, fields: [CreateClassificationTemplateRequestBodyArgFieldsField], hidden: Bool? = nil, copyInstanceOnItemCopy: Bool? = nil) {
        self.scope = scope
    ...
    required public init(from decoder: Decoder) throws {
        ...
        scope = try container.decode(CreateClassificationTemplateRequestBodyArgScopeField.self, forKey: .scope)
        templateKey = try container.decode(CreateClassificationTemplateRequestBodyArgTemplateKeyField.self, forKey: .templateKey)
        displayName = try container.decode(CreateClassificationTemplateRequestBodyArgDisplayNameField.self, forKey: .displayName)
        fields = try container.decode([CreateClassificationTemplateRequestBodyArgFieldsField].self, forKey: .fields)
