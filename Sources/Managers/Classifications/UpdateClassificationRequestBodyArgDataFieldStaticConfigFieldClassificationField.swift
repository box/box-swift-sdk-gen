...
public class UpdateClassificationRequestBodyArgDataFieldStaticConfigFieldClassificationField: Codable {
    ...
    /// Initializer for a UpdateClassificationRequestBodyArgDataFieldStaticConfigFieldClassificationField.
    ///
    /// - Parameters:
