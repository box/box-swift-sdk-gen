...
public class CreateRetentionPolicyAssignmentRequestBodyArgFilterFieldsField: Codable {
    ...
    /// Initializer for a CreateRetentionPolicyAssignmentRequestBodyArgFilterFieldsField.
    ///
    /// - Parameters:
