...
public class CreateRetentionPolicyAssignmentRequestBodyArg: Codable {
    ...
    ///     If the `assigned_to` type is `metadata_template`,
    ///     this field can be a date field's metadata attribute key id.
    public init(policyId: String, assignTo: CreateRetentionPolicyAssignmentRequestBodyArgAssignToField, filterFields: [CreateRetentionPolicyAssignmentRequestBodyArgFilterFieldsField]? = nil, startDateField: String? = nil) {
    ...
    required public init(from decoder: Decoder) throws {
        ...
        assignTo = try container.decode(CreateRetentionPolicyAssignmentRequestBodyArgAssignToField.self, forKey: .assignTo)
        filterFields = try container.decodeIfPresent([CreateRetentionPolicyAssignmentRequestBodyArgFilterFieldsField].self, forKey: .filterFields)
