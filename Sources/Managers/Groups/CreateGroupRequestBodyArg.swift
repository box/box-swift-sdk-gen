...
public class CreateGroupRequestBodyArg: Codable {
    ...
    public let invitabilityLevel: CreateGroupRequestBodyArgInvitabilityLevelField?
    ...
    ///   enterprise
    public let memberViewabilityLevel: CreateGroupRequestBodyArgMemberViewabilityLevelField?

    /// Initializer for a CreateGroupRequestBodyArg.
    ///
    /// - Parameters:
    ...
    ///     * `all_managed_users` - all managed users in the
    ///       enterprise
    public init(name: String, provenance: String? = nil, externalSyncIdentifier: String? = nil, description: String? = nil, invitabilityLevel: CreateGroupRequestBodyArgInvitabilityLevelField? = nil, memberViewabilityLevel: CreateGroupRequestBodyArgMemberViewabilityLevelField? = nil) {
        self.name = name
    ...
    required public init(from decoder: Decoder) throws {
        ...
        invitabilityLevel = try container.decodeIfPresent(CreateGroupRequestBodyArgInvitabilityLevelField.self, forKey: .invitabilityLevel)
        memberViewabilityLevel = try container.decodeIfPresent(CreateGroupRequestBodyArgMemberViewabilityLevelField.self, forKey: .memberViewabilityLevel)
    }
