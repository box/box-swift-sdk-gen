...
public class UpdateGroupByIdRequestBodyArg: Codable {
    ...
    ///     * `all_managed_users` - all managed users in the
    ///       enterprise
    public init(name: String? = nil, provenance: String? = nil, externalSyncIdentifier: String? = nil, description: String? = nil, invitabilityLevel: UpdateGroupByIdRequestBodyArgInvitabilityLevelField? = nil, memberViewabilityLevel: UpdateGroupByIdRequestBodyArgMemberViewabilityLevelField? = nil) {
        self.name = name
    ...
    required public init(from decoder: Decoder) throws {
        ...
        invitabilityLevel = try container.decodeIfPresent(UpdateGroupByIdRequestBodyArgInvitabilityLevelField.self, forKey: .invitabilityLevel)
        memberViewabilityLevel = try container.decodeIfPresent(UpdateGroupByIdRequestBodyArgMemberViewabilityLevelField.self, forKey: .memberViewabilityLevel)
    }
