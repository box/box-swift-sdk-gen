...
public class UpdateCollaborationByIdRequestBodyArg: Codable {
    ...
    ///     
    ///     `can_view_path` can only be used for folder collaborations.
    public init(role: UpdateCollaborationByIdRequestBodyArgRoleField, status: UpdateCollaborationByIdRequestBodyArgStatusField? = nil, expiresAt: String? = nil, canViewPath: Bool? = nil) {
        self.role = role
        self.status = status
    ...
    required public init(from decoder: Decoder) throws {
        ...
        role = try container.decode(UpdateCollaborationByIdRequestBodyArgRoleField.self, forKey: .role)
        status = try container.decodeIfPresent(UpdateCollaborationByIdRequestBodyArgStatusField.self, forKey: .status)
