...
public class CreateCollaborationRequestBodyArgAccessibleByField: Codable {
    ...
    ///     
    ///     Alternatively, use `id` to specify a user by user ID.
    public init(type: CreateCollaborationRequestBodyArgAccessibleByFieldTypeField, id: String? = nil, login: String? = nil) {
        self.type = type
        self.id = id
        self.login = login
    }
    ...
    required public init(from decoder: Decoder) throws {
        ...
        type = try container.decode(CreateCollaborationRequestBodyArgAccessibleByFieldTypeField.self, forKey: .type)
