...
public class UpdateFolderMetadataByIdRequestBodyArg: Codable {
    ...
    ///     from. Required for `move` or `copy` operations and must be in the
    ///     format of a [JSON-Pointer](https://tools.ietf.org/html/rfc6901).
    public init(op: UpdateFolderMetadataByIdRequestBodyArgOpField? = nil, path: String? = nil, value: String? = nil, from: String? = nil) {
        self.op = op
        self.path = path
        self.value = value
        self.from = from
    ...
    required public init(from decoder: Decoder) throws {
        ...
        op = try container.decodeIfPresent(UpdateFolderMetadataByIdRequestBodyArgOpField.self, forKey: .op)
