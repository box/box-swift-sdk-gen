...
public class GetAuthorizeQueryParams {
    ...
    public let responseType: GetAuthorizeQueryParamsResponseTypeField
    ...
    /// Initializer for a GetAuthorizeQueryParams.
    ///
    /// - Parameters:
    ...
    ///     authenticate the user for. This defaults to all the scopes configured
    ///     for the application in its configuration page.
    public init(responseType: GetAuthorizeQueryParamsResponseTypeField, clientId: String, redirectUri: String? = nil, state: String? = nil, scope: String? = nil) {
