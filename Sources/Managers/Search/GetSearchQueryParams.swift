...
public class GetSearchQueryParams {
    ...
    public let scope: GetSearchQueryParamsScopeField?
    ...
    ///    `tags` field.
    public let contentTypes: [GetSearchQueryParamsContentTypesField]?
    ...
    ///    as bookmarks
    public let type: GetSearchQueryParamsTypeField?
    ...
    public let trashContent: GetSearchQueryParamsTrashContentField?
    ...
    public let sort: GetSearchQueryParamsSortField?
    ...
    public let direction: GetSearchQueryParamsDirectionField?
    ...
    /// Initializer for a GetSearchQueryParams.
    ///
    /// - Parameters:
    ...
    ///     
    ///     Data available from 2023-02-01 onwards.
    public init(query: String? = nil, scope: GetSearchQueryParamsScopeField? = nil, fileExtensions: [String]? = nil, createdAtRange: [String]? = nil, updatedAtRange: [String]? = nil, sizeRange: [Int64]? = nil, ownerUserIds: [String]? = nil, recentUpdaterUserIds: [String]? = nil, ancestorFolderIds: [String]? = nil, contentTypes: [GetSearchQueryParamsContentTypesField]? = nil, type: GetSearchQueryParamsTypeField? = nil, trashContent: GetSearchQueryParamsTrashContentField? = nil, mdfilters: [MetadataFilter]? = nil, sort: GetSearchQueryParamsSortField? = nil, direction: GetSearchQueryParamsDirectionField? = nil, limit: Int64? = nil, includeRecentSharedLinks: Bool? = nil, fields: [String]? = nil, offset: Int64? = nil, deletedUserIds: [String]? = nil, deletedAtRange: [String]? = nil) {
        self.query = query
        self.scope = scope
