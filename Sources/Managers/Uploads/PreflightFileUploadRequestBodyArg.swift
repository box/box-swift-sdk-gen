...
public class PreflightFileUploadRequestBodyArg: Codable {
    ...
    required public init(from decoder: Decoder) throws {
        ...
        parent = try container.decodeIfPresent(PreflightFileUploadRequestBodyArgParentField.self, forKey: .parent)
    }
