...
public class GetRetentionPoliciesQueryParamsArg {
    ...
    ///     used when paginating using marker-based pagination.
    public init(policyName: String? = nil, policyType: GetRetentionPoliciesQueryParamsArgPolicyTypeField? = nil, createdByUserId: String? = nil, fields: [String]? = nil, limit: Int64? = nil, marker: String? = nil) {
