...
public class GetLegalHoldPolicyAssignmentsQueryParamsArg {
    ...
    ///     fields for the mini representation are returned, additional
    ///     to the fields requested.
    public init(policyId: String, assignToType: GetLegalHoldPolicyAssignmentsQueryParamsArgAssignToTypeField? = nil, assignToId: String? = nil, marker: String? = nil, limit: Int64? = nil, fields: [String]? = nil) {
