...
public class CreateFileMetadataEnterpriseSecurityClassificationRequestBodyArg: Codable {
    ...
    /// Initializer for a CreateFileMetadataEnterpriseSecurityClassificationRequestBodyArg.
    ///
    /// - Parameters:
