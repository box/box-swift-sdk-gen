...
public class GetIntegrationMappingSlackQueryParams {
    ...
    public let partnerItemType: GetIntegrationMappingSlackQueryParamsPartnerItemTypeField?
    ...
    public let boxItemType: GetIntegrationMappingSlackQueryParamsBoxItemTypeField?

    /// Whether the mapping has been manually created
    public let isManuallyCreated: Bool?

    /// Initializer for a GetIntegrationMappingSlackQueryParams.
    ///
    /// - Parameters:
    ...
    public init(marker: String? = nil, limit: Int64? = nil, partnerItemType: GetIntegrationMappingSlackQueryParamsPartnerItemTypeField? = nil, partnerItemId: String? = nil, boxItemId: String? = nil, boxItemType: GetIntegrationMappingSlackQueryParamsBoxItemTypeField? = nil, isManuallyCreated: Bool? = nil) {
        self.marker = marker
        self.limit = limit
