...
public class GetEventsQueryParamsArg {
    ...
    ///     when requesting the events with a `stream_type` of `admin_logs`. For any
    ///     other `stream_type` this value will be ignored.
    public init(streamType: GetEventsQueryParamsArgStreamTypeField? = nil, streamPosition: String? = nil, limit: Int64? = nil, eventType: [GetEventsQueryParamsArgEventTypeField]? = nil, createdAfter: String? = nil, createdBefore: String? = nil) {
