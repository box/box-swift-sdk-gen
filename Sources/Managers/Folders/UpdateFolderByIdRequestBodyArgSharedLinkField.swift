...
public class UpdateFolderByIdRequestBodyArgSharedLinkField: Codable {
    ...
    /// Initializer for a UpdateFolderByIdRequestBodyArgSharedLinkField.
    ///
    /// - Parameters:
    ...
    ///     expire. This field can only be set by
    ///     users with paid accounts.
    ///   - permissions: UpdateFolderByIdRequestBodyArgSharedLinkFieldPermissionsField?
    public init(access: UpdateFolderByIdRequestBodyArgSharedLinkFieldAccessField? = nil, password: String? = nil, vanityName: String? = nil, unsharedAt: String? = nil, permissions: UpdateFolderByIdRequestBodyArgSharedLinkFieldPermissionsField? = nil) {
        self.access = access
    ...
    required public init(from decoder: Decoder) throws {
        ...
        access = try container.decodeIfPresent(UpdateFolderByIdRequestBodyArgSharedLinkFieldAccessField.self, forKey: .access)
        ...
        permissions = try container.decodeIfPresent(UpdateFolderByIdRequestBodyArgSharedLinkFieldPermissionsField.self, forKey: .permissions)
    }
