...
public class GetFolderItemsQueryParamsArg {
    ...
    ///     (`ASC`) or descending (`DESC`) order.
    public init(fields: [String]? = nil, usemarker: Bool? = nil, marker: String? = nil, offset: Int64? = nil, limit: Int64? = nil, sort: GetFolderItemsQueryParamsArgSortField? = nil, direction: GetFolderItemsQueryParamsArgDirectionField? = nil) {
        self.fields = fields
