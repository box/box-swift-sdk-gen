...
public class GetFolderByIdQueryParamsArg {
    ...
    /// Initializer for a GetFolderByIdQueryParamsArg.
    ///
    /// - Parameters:
    ...
    public init(fields: [String]? = nil, sort: GetFolderByIdQueryParamsArgSortField? = nil, direction: GetFolderByIdQueryParamsArgDirectionField? = nil, offset: Int64? = nil, limit: Int64? = nil) {
        self.fields = fields
        self.sort = sort
