...
public class UpdateFolderByIdRequestBodyArg: Codable {
    ...
    ///     to also set `can_non_owners_invite_collaborators` to
    ///     `false` if it has not already been set.
    public init(name: String? = nil, description: String? = nil, syncState: UpdateFolderByIdRequestBodyArgSyncStateField? = nil, canNonOwnersInvite: Bool? = nil, parent: UpdateFolderByIdRequestBodyArgParentField? = nil, sharedLink: UpdateFolderByIdRequestBodyArgSharedLinkField? = nil, folderUploadEmail: UpdateFolderByIdRequestBodyArgFolderUploadEmailField? = nil, tags: [String]? = nil, isCollaborationRestrictedToEnterprise: Bool? = nil, collections: [UpdateFolderByIdRequestBodyArgCollectionsField]? = nil, canNonOwnersViewCollaborators: Bool? = nil) {
        self.name = name
    ...
    required public init(from decoder: Decoder) throws {
        ...
        syncState = try container.decodeIfPresent(UpdateFolderByIdRequestBodyArgSyncStateField.self, forKey: .syncState)
        canNonOwnersInvite = try container.decodeIfPresent(Bool.self, forKey: .canNonOwnersInvite)
        parent = try container.decodeIfPresent(UpdateFolderByIdRequestBodyArgParentField.self, forKey: .parent)
        sharedLink = try container.decodeIfPresent(UpdateFolderByIdRequestBodyArgSharedLinkField.self, forKey: .sharedLink)
        folderUploadEmail = try container.decodeIfPresent(UpdateFolderByIdRequestBodyArgFolderUploadEmailField.self, forKey: .folderUploadEmail)
        ...
        collections = try container.decodeIfPresent([UpdateFolderByIdRequestBodyArgCollectionsField].self, forKey: .collections)
