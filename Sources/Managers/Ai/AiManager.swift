...
public class AiManager {
    ...
    /// - Returns: The `AiAgentAskResponseOrAiAgentTextGenResponse`.
    /// - Throws: The `GeneralError`.
    public func getAiAgentDefault(queryParams: GetAiAgentDefaultQueryParams, headers: GetAiAgentDefaultHeaders = GetAiAgentDefaultHeaders()) async throws -> AiAgentAskResponseOrAiAgentTextGenResponse {
        ...
        return try AiAgentAskResponseOrAiAgentTextGenResponse.deserialize(from: response.data)
    }
