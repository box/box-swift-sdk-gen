...
public class AiManager {
    ...
    /// - Returns: The `AiAskResponse`.
    /// - Throws: The `GeneralError`.
    public func createAiAsk(requestBody: AiAsk, headers: CreateAiAskHeaders = CreateAiAskHeaders()) async throws -> AiAskResponse {
        ...
        return try AiAskResponse.deserialize(from: response.data)
    }
