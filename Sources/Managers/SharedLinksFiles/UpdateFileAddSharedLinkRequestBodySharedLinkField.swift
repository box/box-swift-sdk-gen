...
public class UpdateFileAddSharedLinkRequestBodySharedLinkField: Codable {
    ...
    /// accounts.
    public let access: UpdateFileAddSharedLinkRequestBodySharedLinkAccessField?
    ...
    public let permissions: UpdateFileAddSharedLinkRequestBodySharedLinkPermissionsField?

    /// Initializer for a UpdateFileAddSharedLinkRequestBodySharedLinkField.
    ///
    /// - Parameters:
    ...
    ///     current date and time.
    ///   - permissions: 
    public init(access: UpdateFileAddSharedLinkRequestBodySharedLinkAccessField? = nil, password: String? = nil, vanityName: String? = nil, unsharedAt: String? = nil, permissions: UpdateFileAddSharedLinkRequestBodySharedLinkPermissionsField? = nil) {
        self.access = access
    ...
    required public init(from decoder: Decoder) throws {
        ...
        access = try container.decodeIfPresent(UpdateFileAddSharedLinkRequestBodySharedLinkAccessField.self, forKey: .access)
        ...
        permissions = try container.decodeIfPresent(UpdateFileAddSharedLinkRequestBodySharedLinkPermissionsField.self, forKey: .permissions)
    }
