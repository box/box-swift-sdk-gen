...
public class UpdateFileAddSharedLinkRequestBodySharedLinkPermissionsField: Codable {
    ...
    /// Initializer for a UpdateFileAddSharedLinkRequestBodySharedLinkPermissionsField.
    ///
    /// - Parameters:
