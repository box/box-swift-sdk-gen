...
public class UpdateSharedLinkOnFileRequestBodySharedLinkField: Codable {
    ...
    ///     current date and time.
    ///   - permissions: 
    public init(access: UpdateSharedLinkOnFileRequestBodySharedLinkAccessField? = nil, password: String? = nil, vanityName: String? = nil, unsharedAt: Date? = nil, permissions: UpdateSharedLinkOnFileRequestBodySharedLinkPermissionsField? = nil) {
        self.access = access
