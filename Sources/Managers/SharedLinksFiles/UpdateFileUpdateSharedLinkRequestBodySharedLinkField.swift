...
public class UpdateFileUpdateSharedLinkRequestBodySharedLinkField: Codable {
    ...
    /// accounts.
    public let access: UpdateFileUpdateSharedLinkRequestBodySharedLinkAccessField?
    ...
    public let permissions: UpdateFileUpdateSharedLinkRequestBodySharedLinkPermissionsField?

    /// Initializer for a UpdateFileUpdateSharedLinkRequestBodySharedLinkField.
    ///
    /// - Parameters:
    ...
    ///     current date and time.
    ///   - permissions: 
    public init(access: UpdateFileUpdateSharedLinkRequestBodySharedLinkAccessField? = nil, password: String? = nil, vanityName: String? = nil, unsharedAt: String? = nil, permissions: UpdateFileUpdateSharedLinkRequestBodySharedLinkPermissionsField? = nil) {
        self.access = access
    ...
    required public init(from decoder: Decoder) throws {
        ...
        access = try container.decodeIfPresent(UpdateFileUpdateSharedLinkRequestBodySharedLinkAccessField.self, forKey: .access)
        ...
        permissions = try container.decodeIfPresent(UpdateFileUpdateSharedLinkRequestBodySharedLinkPermissionsField.self, forKey: .permissions)
    }
