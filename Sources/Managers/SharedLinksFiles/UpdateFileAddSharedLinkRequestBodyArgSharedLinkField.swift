...
public class UpdateFileAddSharedLinkRequestBodyArgSharedLinkField: Codable {
    ...
    /// accounts.
    public let access: UpdateFileAddSharedLinkRequestBodyArgSharedLinkFieldAccessField?
    ...
    public let permissions: UpdateFileAddSharedLinkRequestBodyArgSharedLinkFieldPermissionsField?

    /// Initializer for a UpdateFileAddSharedLinkRequestBodyArgSharedLinkField.
    ///
    /// - Parameters:
    ...
    ///     users with paid accounts. The value must be greater than the
    ///     current date and time.
    ///   - permissions: UpdateFileAddSharedLinkRequestBodyArgSharedLinkFieldPermissionsField?
    public init(access: UpdateFileAddSharedLinkRequestBodyArgSharedLinkFieldAccessField? = nil, password: String? = nil, vanityName: String? = nil, unsharedAt: String? = nil, permissions: UpdateFileAddSharedLinkRequestBodyArgSharedLinkFieldPermissionsField? = nil) {
        self.access = access
    ...
    required public init(from decoder: Decoder) throws {
        ...
        access = try container.decodeIfPresent(UpdateFileAddSharedLinkRequestBodyArgSharedLinkFieldAccessField.self, forKey: .access)
        ...
        permissions = try container.decodeIfPresent(UpdateFileAddSharedLinkRequestBodyArgSharedLinkFieldPermissionsField.self, forKey: .permissions)
    }
