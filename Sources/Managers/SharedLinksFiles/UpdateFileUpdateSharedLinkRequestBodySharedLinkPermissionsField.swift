...
public class UpdateFileUpdateSharedLinkRequestBodySharedLinkPermissionsField: Codable {
    ...
    /// Initializer for a UpdateFileUpdateSharedLinkRequestBodySharedLinkPermissionsField.
    ///
    /// - Parameters:
