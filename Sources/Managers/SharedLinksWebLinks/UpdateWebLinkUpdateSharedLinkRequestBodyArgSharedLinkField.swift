...
public class UpdateWebLinkUpdateSharedLinkRequestBodyArgSharedLinkField: Codable {
    ...
    required public init(from decoder: Decoder) throws {
        ...
        access = try container.decodeIfPresent(UpdateWebLinkUpdateSharedLinkRequestBodyArgSharedLinkFieldAccessField.self, forKey: .access)
        ...
        permissions = try container.decodeIfPresent(UpdateWebLinkUpdateSharedLinkRequestBodyArgSharedLinkFieldPermissionsField.self, forKey: .permissions)
    }
