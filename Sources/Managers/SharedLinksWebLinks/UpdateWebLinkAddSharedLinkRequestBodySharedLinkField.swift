...
public class UpdateWebLinkAddSharedLinkRequestBodySharedLinkField: Codable {
    ...
    /// accounts.
    public let access: UpdateWebLinkAddSharedLinkRequestBodySharedLinkAccessField?
    ...
    public let permissions: UpdateWebLinkAddSharedLinkRequestBodySharedLinkPermissionsField?

    /// Initializer for a UpdateWebLinkAddSharedLinkRequestBodySharedLinkField.
    ///
    /// - Parameters:
    ...
    ///     current date and time.
    ///   - permissions: 
    public init(access: UpdateWebLinkAddSharedLinkRequestBodySharedLinkAccessField? = nil, password: String? = nil, vanityName: String? = nil, unsharedAt: String? = nil, permissions: UpdateWebLinkAddSharedLinkRequestBodySharedLinkPermissionsField? = nil) {
        self.access = access
    ...
    required public init(from decoder: Decoder) throws {
        ...
        access = try container.decodeIfPresent(UpdateWebLinkAddSharedLinkRequestBodySharedLinkAccessField.self, forKey: .access)
        ...
        permissions = try container.decodeIfPresent(UpdateWebLinkAddSharedLinkRequestBodySharedLinkPermissionsField.self, forKey: .permissions)
    }
