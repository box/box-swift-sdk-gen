...
public class UpdateSharedLinkOnWebLinkRequestBodySharedLinkField: Codable {
    ...
    ///     current date and time.
    ///   - permissions: 
    public init(access: UpdateSharedLinkOnWebLinkRequestBodySharedLinkAccessField? = nil, password: String? = nil, vanityName: String? = nil, unsharedAt: Date? = nil, permissions: UpdateSharedLinkOnWebLinkRequestBodySharedLinkPermissionsField? = nil) {
        self.access = access
