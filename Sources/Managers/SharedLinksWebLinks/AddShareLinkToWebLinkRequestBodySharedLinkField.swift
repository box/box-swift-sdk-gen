...
public class AddShareLinkToWebLinkRequestBodySharedLinkField: Codable {
    ...
    ///     current date and time.
    ///   - permissions: 
    public init(access: AddShareLinkToWebLinkRequestBodySharedLinkAccessField? = nil, password: String? = nil, vanityName: String? = nil, unsharedAt: String? = nil, permissions: AddShareLinkToWebLinkRequestBodySharedLinkPermissionsField? = nil) {
        self.access = access
