...
public class AddShareLinkToWebLinkRequestBodySharedLinkField: Codable {
    ...
    ///     current date and time.
    ///   - permissions: 
    public init(access: AddShareLinkToWebLinkRequestBodySharedLinkAccessField? = nil, password: String? = nil, vanityName: String? = nil, unsharedAt: Date? = nil, permissions: AddShareLinkToWebLinkRequestBodySharedLinkPermissionsField? = nil) {
        self.access = access
