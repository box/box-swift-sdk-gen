...
public class CreateMetadataTemplateRequestBodyArg: Codable {
    ...
    /// Initializer for a CreateMetadataTemplateRequestBodyArg.
    ///
    /// - Parameters:
    ...
    ///     when it is copied. By default, metadata is not copied along with a
    ///     file or folder when it is copied.
    public init(scope: String, displayName: String, templateKey: String? = nil, hidden: Bool? = nil, fields: [CreateMetadataTemplateRequestBodyArgFieldsField]? = nil, copyInstanceOnItemCopy: Bool? = nil) {
        self.scope = scope
    ...
    required public init(from decoder: Decoder) throws {
        ...
        fields = try container.decodeIfPresent([CreateMetadataTemplateRequestBodyArgFieldsField].self, forKey: .fields)
