...
public class CreateMetadataTemplateSchemaRequestBodyArgFieldsField: Codable {
    ...
    public let type: CreateMetadataTemplateSchemaRequestBodyArgFieldsFieldTypeField
    ...
    public let options: [CreateMetadataTemplateSchemaRequestBodyArgFieldsFieldOptionsField]?

    /// Initializer for a CreateMetadataTemplateSchemaRequestBodyArgFieldsField.
    ///
    /// - Parameters:
    ...
    ///     `enum` and `multiSelect` field types.
    public init(type: CreateMetadataTemplateSchemaRequestBodyArgFieldsFieldTypeField, key: String, displayName: String, description: String? = nil, hidden: Bool? = nil, options: [CreateMetadataTemplateSchemaRequestBodyArgFieldsFieldOptionsField]? = nil) {
        self.type = type
        self.key = key
    ...
    required public init(from decoder: Decoder) throws {
        ...
        type = try container.decode(CreateMetadataTemplateSchemaRequestBodyArgFieldsFieldTypeField.self, forKey: .type)
        key = try container.decode(String.self, forKey: .key)
        displayName = try container.decode(String.self, forKey: .displayName)
        description = try container.decodeIfPresent(String.self, forKey: .description)
        hidden = try container.decodeIfPresent(Bool.self, forKey: .hidden)
        options = try container.decodeIfPresent([CreateMetadataTemplateSchemaRequestBodyArgFieldsFieldOptionsField].self, forKey: .options)
    }
