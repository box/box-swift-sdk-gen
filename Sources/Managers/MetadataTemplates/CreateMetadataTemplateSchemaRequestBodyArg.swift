...
public class CreateMetadataTemplateSchemaRequestBodyArg: Codable {
    ...
    ///     when it is copied. By default, metadata is not copied along with a
    ///     file or folder when it is copied.
    public init(scope: String, displayName: String, templateKey: String? = nil, hidden: Bool? = nil, fields: [CreateMetadataTemplateSchemaRequestBodyArgFieldsField]? = nil, copyInstanceOnItemCopy: Bool? = nil) {
        self.scope = scope
