...
public class UpdateMetadataTemplateRequestBodyArg: Codable {
    ...
    public let op: UpdateMetadataTemplateRequestBodyArgOpField
    ...
    /// Initializer for a UpdateMetadataTemplateRequestBodyArg.
    ///
    /// - Parameters:
    ...
    ///     defines the keys of the options that are affected.
    public init(op: UpdateMetadataTemplateRequestBodyArgOpField, data: [String: String]? = nil, fieldKey: String? = nil, fieldKeys: [String]? = nil, enumOptionKey: String? = nil, enumOptionKeys: [String]? = nil, multiSelectOptionKey: String? = nil, multiSelectOptionKeys: [String]? = nil) {
        self.op = op
        self.data = data
    ...
    required public init(from decoder: Decoder) throws {
        ...
        op = try container.decode(UpdateMetadataTemplateRequestBodyArgOpField.self, forKey: .op)
