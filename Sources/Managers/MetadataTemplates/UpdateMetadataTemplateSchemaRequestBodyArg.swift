...
public class UpdateMetadataTemplateSchemaRequestBodyArg: Codable {
    ...
    ///     defines the keys of the options that are affected.
    public init(op: UpdateMetadataTemplateSchemaRequestBodyArgOpField, data: [String: String]? = nil, fieldKey: String? = nil, fieldKeys: [String]? = nil, enumOptionKey: String? = nil, enumOptionKeys: [String]? = nil, multiSelectOptionKey: String? = nil, multiSelectOptionKeys: [String]? = nil) {
        self.op = op
        self.data = data
    ...
    required public init(from decoder: Decoder) throws {
        ...
        op = try container.decode(UpdateMetadataTemplateSchemaRequestBodyArgOpField.self, forKey: .op)
