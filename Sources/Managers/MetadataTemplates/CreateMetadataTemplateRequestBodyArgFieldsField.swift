...
public class CreateMetadataTemplateRequestBodyArgFieldsField: Codable {
    ...
    /// Initializer for a CreateMetadataTemplateRequestBodyArgFieldsField.
    ///
    /// - Parameters:
    ...
    ///     `enum` and `multiSelect` field types.
    public init(type: CreateMetadataTemplateRequestBodyArgFieldsFieldTypeField, key: String, displayName: String, description: String? = nil, hidden: Bool? = nil, options: [CreateMetadataTemplateRequestBodyArgFieldsFieldOptionsField]? = nil) {
        self.type = type
        self.key = key
    ...
    required public init(from decoder: Decoder) throws {
        ...
        type = try container.decode(CreateMetadataTemplateRequestBodyArgFieldsFieldTypeField.self, forKey: .type)
        key = try container.decode(String.self, forKey: .key)
        displayName = try container.decode(String.self, forKey: .displayName)
        description = try container.decodeIfPresent(String.self, forKey: .description)
        hidden = try container.decodeIfPresent(Bool.self, forKey: .hidden)
        options = try container.decodeIfPresent([CreateMetadataTemplateRequestBodyArgFieldsFieldOptionsField].self, forKey: .options)
    }
