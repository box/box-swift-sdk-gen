...
public class CreateMetadataTemplateRequestBodyArgFieldsFieldOptionsField: Codable {
    ...
    /// Initializer for a CreateMetadataTemplateRequestBodyArgFieldsFieldOptionsField.
    ///
    /// - Parameters:
