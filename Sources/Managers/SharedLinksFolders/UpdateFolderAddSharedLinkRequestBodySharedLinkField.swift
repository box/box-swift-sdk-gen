...
public class UpdateFolderAddSharedLinkRequestBodySharedLinkField: Codable {
    ...
    /// accounts.
    public let access: UpdateFolderAddSharedLinkRequestBodySharedLinkAccessField?
    ...
    public let permissions: UpdateFolderAddSharedLinkRequestBodySharedLinkPermissionsField?

    /// Initializer for a UpdateFolderAddSharedLinkRequestBodySharedLinkField.
    ///
    /// - Parameters:
    ...
    ///     current date and time.
    ///   - permissions: 
    public init(access: UpdateFolderAddSharedLinkRequestBodySharedLinkAccessField? = nil, password: String? = nil, vanityName: String? = nil, unsharedAt: String? = nil, permissions: UpdateFolderAddSharedLinkRequestBodySharedLinkPermissionsField? = nil) {
        self.access = access
    ...
    required public init(from decoder: Decoder) throws {
        ...
        access = try container.decodeIfPresent(UpdateFolderAddSharedLinkRequestBodySharedLinkAccessField.self, forKey: .access)
        ...
        permissions = try container.decodeIfPresent(UpdateFolderAddSharedLinkRequestBodySharedLinkPermissionsField.self, forKey: .permissions)
    }
