...
public class UpdateFolderUpdateSharedLinkRequestBodySharedLinkField: Codable {
    ...
    /// accounts.
    public let access: UpdateFolderUpdateSharedLinkRequestBodySharedLinkAccessField?
    ...
    public let permissions: UpdateFolderUpdateSharedLinkRequestBodySharedLinkPermissionsField?

    /// Initializer for a UpdateFolderUpdateSharedLinkRequestBodySharedLinkField.
    ///
    /// - Parameters:
    ...
    ///     current date and time.
    ///   - permissions: 
    public init(access: UpdateFolderUpdateSharedLinkRequestBodySharedLinkAccessField? = nil, password: String? = nil, vanityName: String? = nil, unsharedAt: String? = nil, permissions: UpdateFolderUpdateSharedLinkRequestBodySharedLinkPermissionsField? = nil) {
        self.access = access
    ...
    required public init(from decoder: Decoder) throws {
        ...
        access = try container.decodeIfPresent(UpdateFolderUpdateSharedLinkRequestBodySharedLinkAccessField.self, forKey: .access)
        ...
        permissions = try container.decodeIfPresent(UpdateFolderUpdateSharedLinkRequestBodySharedLinkPermissionsField.self, forKey: .permissions)
    }
