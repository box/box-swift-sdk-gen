...
public class UpdateFileMetadataGlobalBoxSkillsCardRequestBody: Codable {
    ...
    /// `replace`
    public let op: UpdateFileMetadataGlobalBoxSkillsCardRequestBodyOpField?
    ...
    /// Initializer for a UpdateFileMetadataGlobalBoxSkillsCardRequestBody.
    ///
    /// - Parameters:
    ///   - op: `replace`
    ...
    ///     zero-indexed position of the card in the list of cards.
    ///   - value: 
    public init(op: UpdateFileMetadataGlobalBoxSkillsCardRequestBodyOpField? = nil, path: String? = nil, value: KeywordSkillCardOrStatusSkillCardOrTimelineSkillCardOrTranscriptSkillCard? = nil) {
        self.op = op
        self.path = path
        self.value = value
    }
    ...
    required public init(from decoder: Decoder) throws {
        ...
        op = try container.decodeIfPresent(UpdateFileMetadataGlobalBoxSkillsCardRequestBodyOpField.self, forKey: .op)
