...
public class CreateMetadataCascadePolicyRequestBodyArg: Codable {
    ...
    ///     [file]: e://get-files-id-metadata
    ///     [folder]: e://get-folders-id-metadata
    public init(folderId: String, scope: CreateMetadataCascadePolicyRequestBodyArgScopeField, templateKey: String) {
    ...
    required public init(from decoder: Decoder) throws {
        ...
        scope = try container.decode(CreateMetadataCascadePolicyRequestBodyArgScopeField.self, forKey: .scope)
