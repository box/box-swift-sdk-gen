...
public class UpdateWebLinkByIdRequestBodyArgSharedLinkField: Codable {
    ...
    /// Initializer for a UpdateWebLinkByIdRequestBodyArgSharedLinkField.
    ///
    /// - Parameters:
    ...
    ///     users with paid accounts. The value must be greater than the
    ///     current date and time.
    public init(access: UpdateWebLinkByIdRequestBodyArgSharedLinkFieldAccessField? = nil, password: String? = nil, vanityName: String? = nil, unsharedAt: String? = nil) {
        self.access = access
    ...
    required public init(from decoder: Decoder) throws {
        ...
        access = try container.decodeIfPresent(UpdateWebLinkByIdRequestBodyArgSharedLinkFieldAccessField.self, forKey: .access)
