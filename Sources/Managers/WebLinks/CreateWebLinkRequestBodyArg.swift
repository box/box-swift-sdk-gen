...
public class CreateWebLinkRequestBodyArg: Codable {
    ...
    public init(url: String, parent: CreateWebLinkRequestBodyArgParentField, name: String? = nil, description: String? = nil) {
        self.url = url
        self.parent = parent
        self.name = name
    ...
    required public init(from decoder: Decoder) throws {
        ...
        parent = try container.decode(CreateWebLinkRequestBodyArgParentField.self, forKey: .parent)
