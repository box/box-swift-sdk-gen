...
public class CreateUserRequestBodyArg: Codable {
    ...
    /// Initializer for a CreateUserRequestBodyArg.
    ///
    /// - Parameters:
    ...
    ///     up the user. This can be used to tie user IDs from external
    ///     identity providers to Box users.
    public init(name: String, login: String? = nil, isPlatformAccessOnly: Bool? = nil, role: CreateUserRequestBodyArgRoleField? = nil, language: String? = nil, isSyncEnabled: Bool? = nil, jobTitle: String? = nil, phone: String? = nil, address: String? = nil, spaceAmount: Int64? = nil, trackingCodes: [TrackingCode]? = nil, canSeeManagedUsers: Bool? = nil, timezone: String? = nil, isExternalCollabRestricted: Bool? = nil, isExemptFromDeviceLimits: Bool? = nil, isExemptFromLoginVerification: Bool? = nil, status: CreateUserRequestBodyArgStatusField? = nil, externalAppUserId: String? = nil) {
        self.name = name
        self.login = login
    ...
    required public init(from decoder: Decoder) throws {
        ...
        role = try container.decodeIfPresent(CreateUserRequestBodyArgRoleField.self, forKey: .role)
        ...
        status = try container.decodeIfPresent(CreateUserRequestBodyArgStatusField.self, forKey: .status)
