...
public class UpdateUserByIdRequestBodyArg: Codable {
    ...
    ///     Note: In order to update this field, you need to request a token
    ///     using the application that created the app user.
    public init(enterprise: String? = nil, notify: Bool? = nil, name: String? = nil, login: String? = nil, role: UpdateUserByIdRequestBodyArgRoleField? = nil, language: String? = nil, isSyncEnabled: Bool? = nil, jobTitle: String? = nil, phone: String? = nil, address: String? = nil, trackingCodes: [TrackingCode]? = nil, canSeeManagedUsers: Bool? = nil, timezone: String? = nil, isExternalCollabRestricted: Bool? = nil, isExemptFromDeviceLimits: Bool? = nil, isExemptFromLoginVerification: Bool? = nil, isPasswordResetRequired: Bool? = nil, status: UpdateUserByIdRequestBodyArgStatusField? = nil, spaceAmount: Int64? = nil, notificationEmail: UpdateUserByIdRequestBodyArgNotificationEmailField? = nil, externalAppUserId: String? = nil) {
    ...
    required public init(from decoder: Decoder) throws {
        ...
        role = try container.decodeIfPresent(UpdateUserByIdRequestBodyArgRoleField.self, forKey: .role)
        ...
        status = try container.decodeIfPresent(UpdateUserByIdRequestBodyArgStatusField.self, forKey: .status)
        spaceAmount = try container.decodeIfPresent(Int64.self, forKey: .spaceAmount)
        notificationEmail = try container.decodeIfPresent(UpdateUserByIdRequestBodyArgNotificationEmailField.self, forKey: .notificationEmail)
