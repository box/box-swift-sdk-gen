...
public class GetUsersQueryParamsArg {
    ...
    ///     
    ///     This requires `usemarker` to be set to `true`.
    public init(filterTerm: String? = nil, userType: GetUsersQueryParamsArgUserTypeField? = nil, externalAppUserId: String? = nil, fields: [String]? = nil, offset: Int64? = nil, limit: Int64? = nil, usemarker: Bool? = nil, marker: String? = nil) {
