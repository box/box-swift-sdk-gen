...
public class UpdateFileByIdRequestBodyArgSharedLinkFieldPermissionsField: Codable {
    ...
    /// Initializer for a UpdateFileByIdRequestBodyArgSharedLinkFieldPermissionsField.
    ///
    /// - Parameters:
