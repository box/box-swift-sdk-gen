...
public class UpdateFileByIdRequestBodyArgSharedLinkField: Codable {
    ...
    required public init(from decoder: Decoder) throws {
        ...
        access = try container.decodeIfPresent(UpdateFileByIdRequestBodyArgSharedLinkFieldAccessField.self, forKey: .access)
        ...
        permissions = try container.decodeIfPresent(UpdateFileByIdRequestBodyArgSharedLinkFieldPermissionsField.self, forKey: .permissions)
    }
