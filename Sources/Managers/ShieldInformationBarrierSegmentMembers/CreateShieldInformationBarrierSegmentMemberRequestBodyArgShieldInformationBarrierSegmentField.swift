...
public class CreateShieldInformationBarrierSegmentMemberRequestBodyArgShieldInformationBarrierSegmentField: Codable {
    ...
    public init(id: String? = nil, type: CreateShieldInformationBarrierSegmentMemberRequestBodyArgShieldInformationBarrierSegmentFieldTypeField? = nil) {
        self.id = id
        self.type = type
    }
    ...
    required public init(from decoder: Decoder) throws {
        ...
        type = try container.decodeIfPresent(CreateShieldInformationBarrierSegmentMemberRequestBodyArgShieldInformationBarrierSegmentFieldTypeField.self, forKey: .type)
    }
