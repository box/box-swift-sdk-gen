...
public class GetFileVersionRetentionsQueryParamsArg {
    ...
    ///     
    ///     This requires `usemarker` to be set to `true`.
    public init(fileId: String? = nil, fileVersionId: String? = nil, policyId: String? = nil, dispositionAction: GetFileVersionRetentionsQueryParamsArgDispositionActionField? = nil, dispositionBefore: String? = nil, dispositionAfter: String? = nil, limit: Int64? = nil, marker: String? = nil) {
        self.fileId = fileId
