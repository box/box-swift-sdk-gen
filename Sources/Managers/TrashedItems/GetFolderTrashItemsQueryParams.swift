...
public class GetFolderTrashItemsQueryParams {
    ...
    public let direction: GetFolderTrashItemsQueryParamsDirectionField?
    ...
    public let sort: GetFolderTrashItemsQueryParamsSortField?

    /// Initializer for a GetFolderTrashItemsQueryParams.
    ///
    /// - Parameters:
    ...
    ///     
    ///     This parameter is not supported when using marker-based pagination.
    public init(fields: [String]? = nil, limit: Int64? = nil, offset: Int64? = nil, usemarker: Bool? = nil, marker: String? = nil, direction: GetFolderTrashItemsQueryParamsDirectionField? = nil, sort: GetFolderTrashItemsQueryParamsSortField? = nil) {
        self.fields = fields
        self.limit = limit
        self.offset = offset
