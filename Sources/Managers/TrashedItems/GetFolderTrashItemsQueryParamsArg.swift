...
public class GetFolderTrashItemsQueryParamsArg {
    ...
    public let direction: GetFolderTrashItemsQueryParamsArgDirectionField?
    ...
    public let sort: GetFolderTrashItemsQueryParamsArgSortField?

    /// Initializer for a GetFolderTrashItemsQueryParamsArg.
    ///
    /// - Parameters:
    ...
    ///     
    ///     This parameter is not supported when using marker-based pagination.
    public init(fields: [String]? = nil, limit: Int64? = nil, offset: Int64? = nil, usemarker: Bool? = nil, marker: String? = nil, direction: GetFolderTrashItemsQueryParamsArgDirectionField? = nil, sort: GetFolderTrashItemsQueryParamsArgSortField? = nil) {
        self.fields = fields
        self.limit = limit
        self.offset = offset
