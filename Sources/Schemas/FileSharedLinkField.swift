...
public class FileSharedLinkField: Codable {
    ...
    ///     These permissions refer to the shared link only and
    ///     do not supersede permissions applied to the item itself.
    public init(url: String, effectiveAccess: FileSharedLinkFieldEffectiveAccessField, effectivePermission: FileSharedLinkFieldEffectivePermissionField, isPasswordEnabled: Bool, downloadCount: Int, previewCount: Int, downloadUrl: String? = nil, vanityUrl: String? = nil, vanityName: String? = nil, access: FileSharedLinkFieldAccessField? = nil, unsharedAt: String? = nil, permissions: FileSharedLinkFieldPermissionsField? = nil) {
        self.url = url
