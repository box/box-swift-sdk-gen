...
public class FileSharedLinkField: Codable {
    ...
    public init(url: String, downloadUrl: String? = nil, vanityUrl: String? = nil, vanityName: String? = nil, access: FileSharedLinkFieldAccessField? = nil, effectiveAccess: FileSharedLinkFieldEffectiveAccessField, effectivePermission: FileSharedLinkFieldEffectivePermissionField, unsharedAt: String? = nil, isPasswordEnabled: Bool, permissions: FileSharedLinkFieldPermissionsField? = nil, downloadCount: Int, previewCount: Int) {
        self.url = url
