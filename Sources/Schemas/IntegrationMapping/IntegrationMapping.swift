...
public class IntegrationMapping: IntegrationMappingBase {
    ...
    ///     last modified the integration mapping
    public init(id: String, boxItem: FolderMini, partnerItem: IntegrationMappingPartnerItemSlackUnion, type: IntegrationMappingBaseTypeField = IntegrationMappingBaseTypeField.integrationMapping, createdAt: Date? = nil, modifiedAt: Date? = nil, integrationType: IntegrationMappingIntegrationTypeField? = nil, isManuallyCreated: Bool? = nil, options: IntegrationMappingSlackOptions? = nil, createdBy: UserIntegrationMappings? = nil, modifiedBy: UserIntegrationMappings? = nil) {
