...
public class AiAgentAskResponse: Codable {
    ...
    public let type: AiAgentAskResponseTypeField?
    ...
    /// Initializer for a AiAgentAskResponse.
    ///
    /// - Parameters:
    ...
    ///   - longTextMulti: 
    ///   - basicTextMulti: 
    public init(type: AiAgentAskResponseTypeField? = nil, longText: AiAgentLongTextTool? = nil, basicText: AiAgentBasicTextToolAsk? = nil, longTextMulti: AiAgentLongTextTool? = nil, basicTextMulti: AiAgentBasicTextToolAsk? = nil) {
        self.type = type
    ...
    required public init(from decoder: Decoder) throws {
        ...
        type = try container.decodeIfPresent(AiAgentAskResponseTypeField.self, forKey: .type)
