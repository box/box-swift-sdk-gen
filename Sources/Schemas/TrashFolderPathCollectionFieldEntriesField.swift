...
public class TrashFolderPathCollectionFieldEntriesField: Codable {
    ...
    public init(type: TrashFolderPathCollectionFieldEntriesFieldTypeField? = nil, id: String? = nil, sequenceId: String? = nil, etag: String? = nil, name: String? = nil) {
        self.type = type
        self.id = id
    ...
    required public init(from decoder: Decoder) throws {
        ...
        type = try container.decodeIfPresent(TrashFolderPathCollectionFieldEntriesFieldTypeField.self, forKey: .type)
