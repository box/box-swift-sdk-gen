...
public class TimelineSkillCardEntriesField: Codable {
    ...
    ///     the image will show the user where that entry
    ///     appears during the duration of this entry.
    public init(text: String? = nil, appears: [TimelineSkillCardEntriesFieldAppearsField]? = nil, imageUrl: String? = nil) {
        self.text = text
    ...
    required public init(from decoder: Decoder) throws {
        ...
        appears = try container.decodeIfPresent([TimelineSkillCardEntriesFieldAppearsField].self, forKey: .appears)
