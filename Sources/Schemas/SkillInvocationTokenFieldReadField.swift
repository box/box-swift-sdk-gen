...
public class SkillInvocationTokenFieldReadField: Codable {
    ...
    public let tokenType: SkillInvocationTokenFieldReadFieldTokenTypeField?
    /// The permissions that this access token permits,
    /// providing a list of resources (files, folders, etc)
    /// and the scopes permitted for each of those resources.,
    public let restrictedTo: String?

    /// Initializer for a SkillInvocationTokenFieldReadField.
    ///
    /// - Parameters:
    ...
    ///     providing a list of resources (files, folders, etc)
    ///     and the scopes permitted for each of those resources.
    public init(accessToken: String? = nil, expiresIn: Int64? = nil, tokenType: SkillInvocationTokenFieldReadFieldTokenTypeField? = nil, restrictedTo: String? = nil) {
    ...
    required public init(from decoder: Decoder) throws {
        ...
        tokenType = try container.decodeIfPresent(SkillInvocationTokenFieldReadFieldTokenTypeField.self, forKey: .tokenType)
