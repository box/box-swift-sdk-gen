...
public class ConflictError: ClientError {
    ...
    public override init(type: ClientErrorTypeField? = nil, status: Int? = nil, code: ClientErrorCodeField? = nil, message: String? = nil, contextInfo: TriStateField<[String: String]> = nil, helpUrl: String? = nil, requestId: String? = nil) {
