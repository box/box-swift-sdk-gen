...
public class FileConflict: FileMini {
    ...
    public override init(id: String, etag: String? = nil, type: FileBaseTypeField, sequenceId: String? = nil, name: String? = nil, sha1: String? = nil, fileVersion: FileVersionMini? = nil) {
