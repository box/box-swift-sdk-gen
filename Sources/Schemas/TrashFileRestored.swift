...
public class TrashFileRestored: Codable {
    ...
    ///     * `trashed` when the item has been moved to the trash but not deleted
    ///     * `deleted` when the item has been permanently deleted.
    public init(id: String, etag: String? = nil, type: TrashFileRestoredTypeField, sequenceId: String, name: String? = nil, sha1: String, fileVersion: FileVersionMini? = nil, description: String, size: Int, pathCollection: TrashFileRestoredPathCollectionField, createdAt: String, modifiedAt: String, trashedAt: String? = nil, purgedAt: String? = nil, contentCreatedAt: String? = nil, contentModifiedAt: String? = nil, createdBy: UserMini? = nil, modifiedBy: UserMini, ownedBy: UserMini, sharedLink: String? = nil, parent: FolderMini? = nil, itemStatus: TrashFileRestoredItemStatusField) {
        self.id = id
        self.etag = etag
        self.type = type
