...
public class FileVersionFull: FileVersion {
    ...
    public init(id: String, type: FileVersionBaseTypeField = FileVersionBaseTypeField.fileVersion, sha1: String? = nil, name: String? = nil, size: Int64? = nil, createdAt: Date? = nil, modifiedAt: Date? = nil, modifiedBy: UserMini? = nil, trashedAt: Date? = nil, trashedBy: UserMini? = nil, restoredAt: Date? = nil, restoredBy: UserMini? = nil, purgedAt: Date? = nil, uploaderDisplayName: String? = nil, versionNumber: String? = nil) {
