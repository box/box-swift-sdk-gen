...
public class TrashFilePathCollectionFieldEntriesField: Codable {
    ...
    /// Initializer for a TrashFilePathCollectionFieldEntriesField.
    ///
    /// - Parameters:
    ///   - type: `folder`
    ...
    public init(type: TrashFilePathCollectionFieldEntriesFieldTypeField? = nil, id: String? = nil, sequenceId: String? = nil, etag: String? = nil, name: String? = nil) {
        self.type = type
        self.id = id
    ...
    required public init(from decoder: Decoder) throws {
        ...
        type = try container.decodeIfPresent(TrashFilePathCollectionFieldEntriesFieldTypeField.self, forKey: .type)
