...
public class SkillInvocationTokenFieldWriteField: Codable {
    ...
    ///     providing a list of resources (files, folders, etc)
    ///     and the scopes permitted for each of those resources.
    public init(accessToken: String? = nil, expiresIn: Int64? = nil, tokenType: SkillInvocationTokenFieldWriteFieldTokenTypeField? = nil, restrictedTo: String? = nil) {
    ...
    required public init(from decoder: Decoder) throws {
        ...
        tokenType = try container.decodeIfPresent(SkillInvocationTokenFieldWriteFieldTokenTypeField.self, forKey: .tokenType)
