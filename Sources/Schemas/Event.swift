...
public class Event: Codable {
    ...
    public let source: UserOrEventSourceOrFileOrFolderOrGenericSource?
    ...
    ///     have an `additional_details` object.  This object is only available in the
    ///     Enterprise Events.
    public init(type: String? = nil, createdAt: String? = nil, recordedAt: String? = nil, eventId: String? = nil, createdBy: UserMini? = nil, eventType: EventEventTypeField? = nil, sessionId: String? = nil, source: UserOrEventSourceOrFileOrFolderOrGenericSource? = nil, additionalDetails: EventAdditionalDetailsField? = nil) {
        self.type = type
    ...
    required public init(from decoder: Decoder) throws {
        ...
        source = try container.decodeIfPresent(UserOrEventSourceOrFileOrFolderOrGenericSource.self, forKey: .source)
