...
public class WebLinkSharedLinkField: Codable {
    ...
    public init(url: String, downloadUrl: String? = nil, vanityUrl: String? = nil, vanityName: String? = nil, access: WebLinkSharedLinkFieldAccessField? = nil, effectiveAccess: WebLinkSharedLinkFieldEffectiveAccessField, effectivePermission: WebLinkSharedLinkFieldEffectivePermissionField, unsharedAt: String? = nil, isPasswordEnabled: Bool, permissions: WebLinkSharedLinkFieldPermissionsField? = nil, downloadCount: Int, previewCount: Int) {
        self.url = url
