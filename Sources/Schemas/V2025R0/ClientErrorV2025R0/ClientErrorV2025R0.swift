...
public class ClientErrorV2025R0: Codable {
    ...
    public let contextInfo: ClientErrorV2025R0ContextInfoField?
    ...
    ///     when contacting Box support.
    public init(type: ClientErrorV2025R0TypeField? = nil, status: Int? = nil, code: ClientErrorV2025R0CodeField? = nil, message: String? = nil, contextInfo: ClientErrorV2025R0ContextInfoField? = nil, helpUrl: String? = nil, requestId: String? = nil) {
        self.type = type
        self.status = status
        self.code = code
