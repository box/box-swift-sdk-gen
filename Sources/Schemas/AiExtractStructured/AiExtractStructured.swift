...
public class AiExtractStructured: Codable {
    ...
    public let aiAgent: AiAgentExtractStructured?
    ...
    ///     For your request to work, you must provide either `metadata_template` or `fields`, but not both.
    ///   - aiAgent: 
    public init(items: [AiItemBase], metadataTemplate: AiExtractStructuredMetadataTemplateField? = nil, fields: [AiExtractStructuredFieldsField]? = nil, aiAgent: AiAgentExtractStructured? = nil) {
        self.items = items
    ...
    required public init(from decoder: Decoder) throws {
        ...
        aiAgent = try container.decodeIfPresent(AiAgentExtractStructured.self, forKey: .aiAgent)
    }
